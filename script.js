    ...
    empfang: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "empfang") { 
             if (~befehl.indexOf("--EMPFANG")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Alice. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(EmpfangsBot+' Hallo Empfang Text 1. ')).then(() => bot.say(EmpfangsBot+' Hallo Empfang Text 2. ')).then(() => 'empfang');}if (~befehl.indexOf("--ALICE")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Alice. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(EmpfangsBot+' Hallo Empfang Text 1. ')).then(() => bot.say(EmpfangsBot+' Hallo Empfang Text 2. ')).then(() => 'empfang');} } else { 
             if (~befehl.indexOf("--EMPFANG")) { versuch = true; return bot.say(EmpfangsBot+' Empfang Text 1. ').then(() => bot.say(EmpfangsBot+' Schreiben Sie --Befehle, um alle meine Inhalte zu sehen. ')).then(() => 'empfang');}if (~befehl.indexOf("--ALICE")) { versuch = true; return bot.say(EmpfangsBot+' Empfang Text 1. ').then(() => bot.say(EmpfangsBot+' Schreiben Sie --Befehle, um alle meine Inhalte zu sehen. ')).then(() => 'empfang');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--TEST")) { versuch = true; return bot.say(EmpfangsBot+' Hallo Welt! ').then(() => 'empfang');}          
